...
public class LearningLocatorsWithChaining {
      ...
      public static void main(String[] args) throws InterruptedException {
		    ...
		    WebElement newUserTextBox=NewUserRegistrationform.findElement(By.name("userName"));
		    newUserTextBox.sendKeys("Neelam");
			WebElement newUserPasswordTextBox=NewUserRegistrationform.findElement(By.name("password"));
